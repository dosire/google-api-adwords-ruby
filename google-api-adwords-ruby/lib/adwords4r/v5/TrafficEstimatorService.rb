...
# {https://adwords.google.com/api/adwords/v5}estimateCampaignList
class EstimateCampaignList < ::Array
  @@schema_element = [
    ["campaignRequests", ["CampaignRequest[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "campaignRequests")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}estimateCampaignListResponse
class EstimateCampaignListResponse < ::Array
  @@schema_element = [
    ["estimateCampaignListReturn", ["CampaignEstimate[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "estimateCampaignListReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}estimateAdGroupList
class EstimateAdGroupList < ::Array
  @@schema_element = [
    ["adGroupRequests", ["AdGroupRequest[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "adGroupRequests")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}estimateAdGroupListResponse
class EstimateAdGroupListResponse < ::Array
  @@schema_element = [
    ["estimateAdGroupListReturn", ["AdGroupEstimate[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "estimateAdGroupListReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}estimateKeywordList
class EstimateKeywordList < ::Array
  @@schema_element = [
    ["keywordRequests", ["KeywordRequest[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "keywordRequests")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}estimateKeywordListResponse
class EstimateKeywordListResponse < ::Array
  @@schema_element = [
    ["estimateKeywordListReturn", ["KeywordEstimate[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "estimateKeywordListReturn")]]
  ]
end
...
# {https://adwords.google.com/api/adwords/v5}CampaignRequest
...
# {https://adwords.google.com/api/adwords/v5}AdGroupRequest
...
# {https://adwords.google.com/api/adwords/v5}KeywordRequest
...
# {https://adwords.google.com/api/adwords/v5}CampaignEstimate
...
# {https://adwords.google.com/api/adwords/v5}AdGroupEstimate
...
# {https://adwords.google.com/api/adwords/v5}KeywordEstimate
