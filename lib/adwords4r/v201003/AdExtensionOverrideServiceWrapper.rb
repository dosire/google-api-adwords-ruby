...
# library setup.
require 'adwords4r/v201003/AdExtensionOverrideServiceDriver.rb'

module AdWords
  module V201003
    module AdExtensionOverrideService

      # Wrapper class for the v201003 AdExtensionOverride service.
      ...
      class AdExtensionOverrideServiceWrapper
        ...
        # instead of
        #  AdWords::V201003::AdExtensionOverrideService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201003::AdExtensionOverrideService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201003::AdExtensionOverrideService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201003::AdExtensionOverrideService::AdExtensionOverrideOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201003::AdExtensionOverrideService::Mutate.new(operations)
