  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V201003::CampaignTargetService::ApiException"=>{:ns=>"https://adwords.google.com/api/adwords/cm/v201003", :encodingstyle=>"document", :namespace=>nil, :name=>"ApiException", :use=>"literal"}} }
    ],
    [ "",
      "mutate",
