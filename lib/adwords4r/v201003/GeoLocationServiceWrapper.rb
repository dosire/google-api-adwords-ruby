...
# library setup.
require 'adwords4r/v201003/GeoLocationServiceDriver.rb'

module AdWords
  module V201003
    module GeoLocationService

      # Wrapper class for the v201003 GeoLocation service.
      ...
      class GeoLocationServiceWrapper
        ...
        # instead of
        #  AdWords::V201003::GeoLocationService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201003::GeoLocationService
        end
        ...
        #
        # Returns:
        # - rval: SOAP::SOAPArray of AdWords::V201003::GeoLocationService::GeoLocation
        #
        # Raises:
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201003::GeoLocationService::Get.new(selector)
