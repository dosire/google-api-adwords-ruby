...
# library setup.
require 'adwords4r/v201003/AdGroupServiceDriver.rb'

module AdWords
  module V201003
    module AdGroupService

      # Wrapper class for the v201003 AdGroup service.
      ...
      class AdGroupServiceWrapper
        ...
        # instead of
        #  AdWords::V201003::AdGroupService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201003::AdGroupService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201003::AdGroupService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201003::AdGroupService::AdGroupOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201003::AdGroupService::Mutate.new(operations)
