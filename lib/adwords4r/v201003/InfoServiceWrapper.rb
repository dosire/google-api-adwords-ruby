...
# library setup.
require 'adwords4r/v201003/InfoServiceDriver.rb'

module AdWords
  module V201003
    module InfoService

      # Wrapper class for the v201003 Info service.
      ...
      class InfoServiceWrapper
        ...
        # instead of
        #  AdWords::V201003::InfoService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201003::InfoService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201003::InfoService::Get.new(selector)
