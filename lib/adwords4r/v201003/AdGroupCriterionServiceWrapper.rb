...
# library setup.
require 'adwords4r/v201003/AdGroupCriterionServiceDriver.rb'

module AdWords
  module V201003
    module AdGroupCriterionService

      # Wrapper class for the v201003 AdGroupCriterion service.
      ...
      class AdGroupCriterionServiceWrapper
        ...
        # instead of
        #  AdWords::V201003::AdGroupCriterionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V201003::AdGroupCriterionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V201003::AdGroupCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V201003::AdGroupCriterionService::AdGroupCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V201003::AdGroupCriterionService::Mutate.new(operations)
