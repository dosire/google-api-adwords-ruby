...
module DefaultMappingRegistry
  ...
  LiteralRegistry.register(
    ...
    :schema_element => [
      ["getUnitCountForClientsReturn", ["AdWords::InfoService::ClientUsageRecord[]", XSD::QName.new("https://adwords.google.com/api/adwords/v10", "getUnitCountForClientsReturn")], [1, nil]]
    ]
  )
