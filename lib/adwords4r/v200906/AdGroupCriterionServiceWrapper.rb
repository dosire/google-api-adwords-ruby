...
# library setup.
require 'adwords4r/v200906/AdGroupCriterionServiceDriver.rb'

module AdWords
  module V200906
    module AdGroupCriterionService

      # Wrapper class for the v200906 AdGroupCriterion service.
      ...
      class AdGroupCriterionServiceWrapper
        ...
        # instead of
        #  AdWords::V200906::AdGroupCriterionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200906::AdGroupCriterionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200906::AdGroupCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200906::AdGroupCriterionService::AdGroupCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200906::AdGroupCriterionService::Mutate.new(operations)
