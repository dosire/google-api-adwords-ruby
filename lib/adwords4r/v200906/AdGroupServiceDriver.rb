...
require 'adwords4r/v200906/AdGroupServiceMappingRegistry'
...
class AdGroupServiceInterface < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://adwords.google.com/api/adwords/cm/v200906/AdGroupService"
  ...
  Methods = [
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        ...
        :faults => {"AdWords::V200906::AdGroupService::ApiException"=>{:encodingstyle=>"document", :name=>"ApiException", :use=>"literal", :ns=>"https://adwords.google.com/api/adwords/cm/v200906", :namespace=>nil}} }
    ],
    [ "",
      "mutate",
