...
# library setup.
require 'adwords4r/v200906/CampaignServiceDriver.rb'

module AdWords
  module V200906
    module CampaignService

      # Wrapper class for the v200906 Campaign service.
      ...
      class CampaignServiceWrapper
        ...
        # instead of
        #  AdWords::V200906::CampaignService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200906::CampaignService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200906::CampaignService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200906::CampaignService::CampaignOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200906::CampaignService::Mutate.new(operations)
