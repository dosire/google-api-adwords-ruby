...
# library setup.
require 'adwords4r/v200909/AdParamServiceDriver.rb'

module AdWords
  module V200909
    module AdParamService

      # Wrapper class for the v200909 AdParam service.
      ...
      class AdParamServiceWrapper
        ...
        # instead of
        #  AdWords::V200909::AdParamService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200909::AdParamService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200909::AdParamService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200909::AdParamService::AdParamOperation
        #
        # Returns:
        # - rval: SOAP::SOAPArray of AdWords::V200909::AdParamService::AdParam
        #
        # Raises:
        # Error::ApiError (or a subclass thereof) if a SOAP fault occurs.
        #
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200909::AdParamService::Mutate.new(operations)
