...
# library setup.
require 'adwords4r/v200909/AdExtensionOverrideServiceDriver.rb'

module AdWords
  module V200909
    module AdExtensionOverrideService

      # Wrapper class for the v200909 AdExtensionOverride service.
      ...
      class AdExtensionOverrideServiceWrapper
        ...
        # instead of
        #  AdWords::V200909::AdExtensionOverrideService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200909::AdExtensionOverrideService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200909::AdExtensionOverrideService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200909::AdExtensionOverrideService::AdExtensionOverrideOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200909::AdExtensionOverrideService::Mutate.new(operations)
