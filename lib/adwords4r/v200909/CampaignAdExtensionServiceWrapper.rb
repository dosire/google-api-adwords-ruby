...
# library setup.
require 'adwords4r/v200909/CampaignAdExtensionServiceDriver.rb'

module AdWords
  module V200909
    module CampaignAdExtensionService

      # Wrapper class for the v200909 CampaignAdExtension service.
      ...
      class CampaignAdExtensionServiceWrapper
        ...
        # instead of
        #  AdWords::V200909::CampaignAdExtensionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200909::CampaignAdExtensionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200909::CampaignAdExtensionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200909::CampaignAdExtensionService::CampaignAdExtensionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200909::CampaignAdExtensionService::Mutate.new(operations)
