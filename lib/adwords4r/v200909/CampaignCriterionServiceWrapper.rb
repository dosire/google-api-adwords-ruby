...
# library setup.
require 'adwords4r/v200909/CampaignCriterionServiceDriver.rb'

module AdWords
  module V200909
    module CampaignCriterionService

      # Wrapper class for the v200909 CampaignCriterion service.
      ...
      class CampaignCriterionServiceWrapper
        ...
        # instead of
        #  AdWords::V200909::CampaignCriterionService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200909::CampaignCriterionService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200909::CampaignCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200909::CampaignCriterionService::CampaignCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200909::CampaignCriterionService::Mutate.new(operations)
