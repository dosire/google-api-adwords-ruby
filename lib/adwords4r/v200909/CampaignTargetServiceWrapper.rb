...
# library setup.
require 'adwords4r/v200909/CampaignTargetServiceDriver.rb'

module AdWords
  module V200909
    module CampaignTargetService

      # Wrapper class for the v200909 CampaignTarget service.
      ...
      class CampaignTargetServiceWrapper
        ...
        # instead of
        #  AdWords::V200909::CampaignTargetService::ClassName
        ...
        def initialize(driver, api)
          @driver = driver
          @api = api
          @module = AdWords::V200909::CampaignTargetService
        end
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200909::CampaignTargetService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200909::CampaignTargetService::CampaignTargetOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200909::CampaignTargetService::Mutate.new(operations)
