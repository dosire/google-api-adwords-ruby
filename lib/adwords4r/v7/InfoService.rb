...
# {https://adwords.google.com/api/adwords/v7}getOperationCount
...
# {https://adwords.google.com/api/adwords/v7}getOperationCountResponse
...
# {https://adwords.google.com/api/adwords/v7}getOperationsQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v7}getOperationsQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v7}getUsageQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v7}getUsageQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v7}getFreeUsageQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v7}getFreeUsageQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v7}getMethodCost
class GetMethodCost
...
# {https://adwords.google.com/api/adwords/v7}getMethodCostResponse
...
# {https://adwords.google.com/api/adwords/v7}getUnitCount
class GetUnitCount
...
# {https://adwords.google.com/api/adwords/v7}getUnitCountResponse
...
# {https://adwords.google.com/api/adwords/v7}getUnitCountForMethod
...
# {https://adwords.google.com/api/adwords/v7}getUnitCountForMethodResponse
...
# {https://adwords.google.com/api/adwords/v7}getUnitCountForClients
...
# {https://adwords.google.com/api/adwords/v7}getUnitCountForClientsResponse
...
# {https://adwords.google.com/api/adwords/v7}ClientUsageRecord
