...
# {https://adwords.google.com/api/adwords/v8}getFreeUsageQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v8}getFreeUsageQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v8}getMethodCost
class GetMethodCost
...
# {https://adwords.google.com/api/adwords/v8}getMethodCostResponse
...
# {https://adwords.google.com/api/adwords/v8}getOperationCount
...
# {https://adwords.google.com/api/adwords/v8}getOperationCountResponse
...
# {https://adwords.google.com/api/adwords/v8}getOperationsQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v8}getOperationsQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v8}getUnitCount
class GetUnitCount
...
# {https://adwords.google.com/api/adwords/v8}getUnitCountForClients
...
# {https://adwords.google.com/api/adwords/v8}getUnitCountForClientsResponse
...
# {https://adwords.google.com/api/adwords/v8}getUnitCountForMethod
...
# {https://adwords.google.com/api/adwords/v8}getUnitCountForMethodResponse
...
# {https://adwords.google.com/api/adwords/v8}getUnitCountResponse
...
# {https://adwords.google.com/api/adwords/v8}getUsageQuotaThisMonth
...
# {https://adwords.google.com/api/adwords/v8}getUsageQuotaThisMonthResponse
...
# {https://adwords.google.com/api/adwords/v8}ClientUsageRecord
