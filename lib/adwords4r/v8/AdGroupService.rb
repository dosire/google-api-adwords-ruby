...
# {https://adwords.google.com/api/adwords/v8}addAdGroup
class AddAdGroup
...
# {https://adwords.google.com/api/adwords/v8}addAdGroupList
...
# {https://adwords.google.com/api/adwords/v8}addAdGroupListResponse
...
# {https://adwords.google.com/api/adwords/v8}addAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v8}getAdGroup
class GetAdGroup
...
# {https://adwords.google.com/api/adwords/v8}getAdGroupList
...
# {https://adwords.google.com/api/adwords/v8}getAdGroupListResponse
...
# {https://adwords.google.com/api/adwords/v8}getAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v8}getAdGroupStats
...
# {https://adwords.google.com/api/adwords/v8}getAdGroupStatsResponse
...
# {https://adwords.google.com/api/adwords/v8}getAllAdGroups
...
# {https://adwords.google.com/api/adwords/v8}getAllAdGroupsResponse
...
# {https://adwords.google.com/api/adwords/v8}updateAdGroup
class UpdateAdGroup
...
# {https://adwords.google.com/api/adwords/v8}updateAdGroupList
...
# {https://adwords.google.com/api/adwords/v8}updateAdGroupListResponse
...
# {https://adwords.google.com/api/adwords/v8}updateAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v8}AdGroup
class AdGroup
  @@schema_type = "AdGroup"
  @@schema_ns = "https://adwords.google.com/api/adwords/v8"
