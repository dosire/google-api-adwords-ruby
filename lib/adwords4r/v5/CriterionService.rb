...
# {https://adwords.google.com/api/adwords/v5}getAllCriteria
...
# {https://adwords.google.com/api/adwords/v5}getAllCriteriaResponse
class GetAllCriteriaResponse < ::Array
  @@schema_element = [
    ["getAllCriteriaReturn", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getAllCriteriaReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}getCriteria
class GetCriteria
...
# {https://adwords.google.com/api/adwords/v5}getCriteriaResponse
class GetCriteriaResponse < ::Array
  @@schema_element = [
    ["getCriteriaReturn", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getCriteriaReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}updateCriteria
class UpdateCriteria < ::Array
  @@schema_element = [
    ["Criteria", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "Criteria")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}updateCriteriaResponse
...
# {https://adwords.google.com/api/adwords/v5}addCriteria
class AddCriteria < ::Array
  @@schema_element = [
    ["newCriteria", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "newCriteria")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}addCriteriaResponse
class AddCriteriaResponse < ::Array
  @@schema_element = [
    ["addCriteriaReturn", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "addCriteriaReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}removeCriteria
...
# {https://adwords.google.com/api/adwords/v5}removeCriteriaResponse
...
# {https://adwords.google.com/api/adwords/v5}getCriterionStats
...
# {https://adwords.google.com/api/adwords/v5}getCriterionStatsResponse
class GetCriterionStatsResponse < ::Array
  @@schema_element = [
    ["getCriterionStatsReturn", ["StatsRecord[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getCriterionStatsReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}getCampaignNegativeCriteria
...
# {https://adwords.google.com/api/adwords/v5}getCampaignNegativeCriteriaResponse
class GetCampaignNegativeCriteriaResponse < ::Array
  @@schema_element = [
    ["getCampaignNegativeCriteriaReturn", ["Criterion[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getCampaignNegativeCriteriaReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}setCampaignNegativeCriteria
...
# {https://adwords.google.com/api/adwords/v5}setCampaignNegativeCriteriaResponse
...
# {https://adwords.google.com/api/adwords/v5}Website
class Website
  @@schema_type = "Website"
  @@schema_ns = "https://adwords.google.com/api/adwords/v5"
  @@schema_element = [
