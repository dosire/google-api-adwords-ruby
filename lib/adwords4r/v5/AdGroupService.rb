...
# {https://adwords.google.com/api/adwords/v5}getAdGroupList
class GetAdGroupList < ::Array
  @@schema_element = [
    ["adgroupIDs", ["SOAP::SOAPInt[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "adgroupIDs")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}getAdGroupListResponse
class GetAdGroupListResponse < ::Array
  @@schema_element = [
    ["getAdGroupListReturn", ["AdGroup[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getAdGroupListReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}getAllAdGroups
...
# {https://adwords.google.com/api/adwords/v5}getAllAdGroupsResponse
class GetAllAdGroupsResponse < ::Array
  @@schema_element = [
    ["getAllAdGroupsReturn", ["AdGroup[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getAllAdGroupsReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}getAdGroup
class GetAdGroup
...
# {https://adwords.google.com/api/adwords/v5}getAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v5}addAdGroup
class AddAdGroup
...
# {https://adwords.google.com/api/adwords/v5}addAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v5}addAdGroupList
...
# {https://adwords.google.com/api/adwords/v5}addAdGroupListResponse
class AddAdGroupListResponse < ::Array
  @@schema_element = [
    ["addAdGroupListReturn", ["AdGroup[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "addAdGroupListReturn")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}updateAdGroup
class UpdateAdGroup
...
# {https://adwords.google.com/api/adwords/v5}updateAdGroupResponse
...
# {https://adwords.google.com/api/adwords/v5}updateAdGroupList
class UpdateAdGroupList < ::Array
  @@schema_element = [
    ["changedData", ["AdGroup[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "changedData")]]
  ]
end

# {https://adwords.google.com/api/adwords/v5}updateAdGroupListResponse
...
# {https://adwords.google.com/api/adwords/v5}getAdGroupStats
...
# {https://adwords.google.com/api/adwords/v5}getAdGroupStatsResponse
class GetAdGroupStatsResponse < ::Array
  @@schema_element = [
    ["getAdGroupStatsReturn", ["StatsRecord[]", XSD::QName.new("https://adwords.google.com/api/adwords/v5", "getAdGroupStatsReturn")]]
  ]
end
...
# {https://adwords.google.com/api/adwords/v5}AdGroup
class AdGroup
  @@schema_type = "AdGroup"
  @@schema_ns = "https://adwords.google.com/api/adwords/v5"
  @@schema_element = [
