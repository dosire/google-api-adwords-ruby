...
# library setup.
require 'adwords4r/v200902/AdGroupAdServiceDriver.rb'

module AdWords
  module V200902
    module AdGroupAdService

      # Wrapper class for the v200902 AdGroupAd service.
      ...
      class AdGroupAdServiceWrapper
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200902::AdGroupAdService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200902::AdGroupAdService::AdGroupAdOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200902::AdGroupAdService::Mutate.new(operations)
