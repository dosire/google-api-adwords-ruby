...
# library setup.
require 'adwords4r/v200902/CampaignCriterionServiceDriver.rb'

module AdWords
  module V200902
    module CampaignCriterionService

      # Wrapper class for the v200902 CampaignCriterion service.
      ...
      class CampaignCriterionServiceWrapper
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200902::CampaignCriterionService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200902::CampaignCriterionService::CampaignCriterionOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200902::CampaignCriterionService::Mutate.new(operations)
