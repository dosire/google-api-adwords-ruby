...
# library setup.
require 'adwords4r/v200902/AdGroupServiceDriver.rb'

module AdWords
  module V200902
    module AdGroupService

      # Wrapper class for the v200902 AdGroup service.
      ...
      class AdGroupServiceWrapper
        ...
        #
        # Args:
        # - selector: AdWords::V200902::AdGroupService::AdGroupSelector
        #
        # Returns:
        ...
        def get(selector)
          begin
            ...
            obj = AdWords::V200902::AdGroupService::Get.new(selector)
        ...
        #
        # Args:
        # - operations: SOAP::SOAPArray of AdWords::V200902::AdGroupService::AdGroupOperation
        #
        # Returns:
        ...
        def mutate(operations)
          begin
            ...
            # Construct request object and make API call
            obj = AdWords::V200902::AdGroupService::Mutate.new(operations)
